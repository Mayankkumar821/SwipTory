...
export default function Index() {
  ...
  let handleSubmit = async (e) => {
    ...
    if (len >= 3) {
      console.log("called");
      await axios
        .get(`${process.env.REACT_APP_HOST}/api/edit-story/${editStoryId}`, {
          params: {
            category: cat1,
        ...
        .then((res) => {
          toast.success("Congrats, Story Edited :)", {
            position: "top-right",
            style: {
              width: "20rem",
              height: "5rem",
  ...
  let getData = async () => {
    ...
    let cat;
    await axios
      .get(`${process.env.REACT_APP_HOST}/api/get-story/${editStoryId}`)
      .then((res) => {
        arr = res.data.docs;
        cat = res.data.cat;
        // console.log(arr);
  ...
  return (
    <div className="edit-story-pop">
      <Toaster />
      {innerWidth < 500 && (
        <h1 className="mb-heading-edit-story">Edit story to feed</h1>
      )}
      <div className="edit-story-wrapper">
        <div className="close-caption">
          <img
            src="close.png"
            alt=""
            className="close-edit-story"
        ...
        <div className="slides-view">
          ...
          >
            <p className="slide-number-edit-story">Slide 1</p>
          </div>
          <div
            className="a-slide-number"
          ...
          >
            <p className="slide-number-edit-story">Slide 2</p>
          </div>
          <div
            className="a-slide-number"
          ...
          >
            <p className="slide-number-edit-story">Slide 3</p>
          </div>
          {addStoryArr.map((slide) => (
            ...
            >
              <p className="slide-number-edit-story">Slide {slide}</p>
              <img
                src="close.png"
                alt=""
          ...
          {addStoryArr.length < 3 && (
            <div
              className="edit-slide-number"
              onClick={() => onClickAddSlide(addStoryArr.length + 4)}
            >
              <p className="slide-number-edit-story">Add +</p>
            </div>
          )}
        </div>
        <div className="form-edit-story">
          <form
